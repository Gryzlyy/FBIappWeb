...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\AddAgentsType' => ['privates', 'App\\Form\\AddAgentsType', 'getAddAgentsTypeService', true],
            'App\\Form\\AddContactType' => ['privates', 'App\\Form\\AddContactType', 'getAddContactTypeService', true],
            'App\\Form\\AddHideoutType' => ['privates', 'App\\Form\\AddHideoutType', 'getAddHideoutTypeService', true],
            'App\\Form\\AddMissionType' => ['privates', 'App\\Form\\AddMissionType', 'getAddMissionTypeService', true],
            'App\\Form\\AddSkillType' => ['privates', 'App\\Form\\AddSkillType', 'getAddSkillTypeService', true],
            'App\\Form\\AddTargetType' => ['privates', 'App\\Form\\AddTargetType', 'getAddTargetTypeService', true],
            ...
            'App\\Form\\AddAgentsType' => '?',
            'App\\Form\\AddContactType' => '?',
            'App\\Form\\AddHideoutType' => '?',
            'App\\Form\\AddMissionType' => '?',
            'App\\Form\\AddSkillType' => '?',
            'App\\Form\\AddTargetType' => '?',
